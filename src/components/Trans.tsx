...
const translations: {[key in keyof typeof TextCodes]: {[code: string]: string}} = {
    ...
    courses : {he: 'קורסים', ar: 'دورات'},
    name : {he: 'שם', ar: 'اسم'},
    description : {he: 'תיאור', ar: 'وصف'},
    aboutMe : {he: 'קצת על עצמי', ar: 'قليلا عني'},
    myItems : {he: 'העבודות שלי', ar: 'مشاريعي'},
    newItem : {he: 'פריט חדש', ar: 'عنصر جديد'},
    students : {he: 'תלמידים', ar : 'طلاب'},
    save : {he: 'שמור', ar: 'إحفظ'},
    cancel : {he: 'ביטול', ar: 'إلغاء'},
    confirm : {he: 'האם אתה בטוח?', ar: 'هل أنت واثق؟'},
    ...
    expectingOperator : {he: 'אמור לבוא אופרטור אחרי הפרמטר', ar: 'يجب أن تأتي المشغل بعد المعلمة'},
    unclosedBraces : {he: 'שגיאה בסגירת הסוגריים', ar: 'خطأ في إغلاق الأقواس'},
    ...
    condFailElse_val: {he: 'התנאי החזיר {val} - נכנס במקום ל else', ar: 'حالة الإرجاع {val} - دخلت بدلا من else'},
